...
let s:style = get(g:, 'fourcolor', 'dark')
...
let s:palette.bg        = {'dark': "#1c1d21",  'light': "#EBF5F7", 'retro': "#c0c0c0"}
let s:palette.comment   = {'dark': "#323232",  'light': "#ABB0B6", 'retro': "#515151"}
let s:palette.markup    = {'dark': "#F07178",  'light': "#F05181", 'retro': "#F06991"}
let s:palette.constant  = {'dark': "#df2935",  'light': "#A33ACC", 'retro': "#df2931"}
let s:palette.operator  = {'dark': "#3cbbb1",  'light': "#E2C247", 'retro': "#1b4965"}
let s:palette.tag       = {'dark': "#36A3D9",  'light': "#36A3D9", 'retro': "#00509d"}
let s:palette.regexp    = {'dark': "#95E6CB",  'light': "#1CBF59", 'retro': "#ff0054"}
let s:palette.string    = {'dark': "#B8CC52",  'light': "#48B300", 'retro': "#8093f1"}
let s:palette.function  = {'dark': "#b388eb",  'light': "#F29111", 'retro': "#5a189a"}
let s:palette.special   = {'dark': "#06d6a0",  'light': "#E9B111", 'retro': "#2ec4b6"}
let s:palette.keyword   = {'dark': "#e36414",  'light': "#FF7733", 'retro': "#e25304"}

let s:palette.error     = {'dark': "#FF3333",  'light': "#FF3333", 'retro': "#FF2222"}
let s:palette.accent    = {'dark': "#F29718",  'light': "#FF6A00", 'retro': "#F18607"}
let s:palette.panel     = {'dark': "#1c1d21",  'light': "#FFFFFF", 'retro': "#343535"}
let s:palette.guide     = {'dark': "#2D3640",  'light': "#708090", 'retro': "#1D2530"}
let s:palette.line      = {'dark': "#1c1d21",  'light': "#F3F3F3", 'retro': "#343535"}
let s:palette.selection = {'dark': "#1c1d21",  'light': "#F0EEE4", 'retro': "#343535"}
let s:palette.fg        = {'dark': "#adb5bd",  'light': "#5C6769", 'retro': "#323232"}
let s:palette.fg_idle   = {'dark': "#3E4B59",  'light': "#828C99", 'retro': "#2E3B48"}
...
if has("nvim")
  ...
  let g:terminal_ansi_colors += [s:palette.regexp[s:style],  "#000000"]
