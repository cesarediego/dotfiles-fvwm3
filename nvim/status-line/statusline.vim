...
function! RedrawModeColors(mode) " {{{
    " Normal mode
    if a:mode == 'n'
        hi CustomStatuslineAccent     cterm=none gui=none ctermbg=none ctermfg=1   guibg=none    guifg=#a2d2ff
        hi CustomStatuslineAccentBody cterm=none gui=none ctermbg=1    ctermfg=0   guibg=#a2d2ff guifg=#272c38
        hi CustomStatuslineFilename   cterm=none gui=none ctermbg=8    ctermfg=251 guibg=#272c38 guifg=#FFFFFF
        " Insert mode
    elseif a:mode == 'i'
        ...
        " Replace mode
    elseif a:mode == 'R'
        hi CustomStatuslineAccent     cterm=none gui=none ctermbg=none ctermfg=1   guibg=none    guifg=#83c5be
        hi CustomStatuslineAccentBody cterm=none gui=none ctermbg=1    ctermfg=0   guibg=#83c5be guifg=#272c38
        hi CustomStatuslineFilename   cterm=none gui=none ctermbg=8    ctermfg=251 guibg=#272c38 guifg=#83c5be
        " Visual mode
    elseif a:mode == 'v' || a:mode == 'V' || a:mode == "\<C-V>"
        ...
        " Command mode
    elseif a:mode == 'c'
        hi CustomStatuslineAccent     cterm=none gui=none ctermbg=none ctermfg=6   guibg=none    guifg=#f4a261
        hi CustomStatuslineAccentBody cterm=none gui=none ctermbg=6    ctermfg=0   guibg=#f4a261 guifg=#272c38
        hi CustomStatuslineFilename   cterm=none gui=none ctermbg=8    ctermfg=6 guibg=#272c38 guifg=#f4a261
        " Terminal mode
    elseif a:mode == 't'
...
function GitBranchIcon()
    if strlen(FugitiveHead())>0 && winwidth(0) > 70
        ...
        hi CustomStatuslineGitbranchIcon      cterm=none gui=none ctermbg=0    ctermfg=0 guibg=#1d212a guifg=#FFFFFF
...
function! SetActiveStatusLine()
    ...
    let statusline .= "%#CustomStatuslineTotalLinesIcon#Line "
